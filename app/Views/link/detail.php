    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-8 mx-auto">
          <h2>Detail Safelink</h2>
          <hr class="hr">
          <p class="lead">
          <?=form_open_multipart('link/update', ['class' => 'form-detail', 'id' => 'formdetail'])?>
            ...
            <div class="form-group">
              <img src="<?=base_url('uploads/'.esc($data->gambar_project))?>" alt="<?=esc($data->gambar_project)?>" title="<?=esc($data->gambar_project)?>" width="150" height="150">
              <hr class="hr">
