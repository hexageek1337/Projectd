...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="mainNav">
	<div class="container">
		<a class="navbar-brand js-scroll-trigger" href="<?=base_url('link')?>"><?=$config->title?></a>
...
<header class="bg-primary text-white">
	<div class="container text-center">
		...
		<p class="lead">Projectd is landing page portofolio from <strong>Denny Septian Panggabean</strong> with Codeigniter 4 and Bootstrap 4</p>
	</div>
</header>